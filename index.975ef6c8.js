...
var _getCountryApiJs = require("./js/getCountryApi.js");
var _makeQueryWordJs = require("./js/makeQueryWord.js");
var _markupJs = require("./js/markup.js");

},{"./js/markup.js":"3TIfq","./js/makeQueryWord.js":"hj01v","./js/getCountryApi.js":"g4RcM"}],"3TIfq":[function(require,module,exports,__globalThis) {
...
const makeMarkup = (data)=>{
    ...
    if (lengthOfAllFindingCountry > 10) (0, _core.error)({
        title: '',
    ...
    if (lengthOfAllFindingCountry < 10 && lengthOfAllFindingCountry > 2) data.map((item)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@pnotify/core":"9RSjy"}],"gkKU3":[function(require,module,exports,__globalThis) {
...
},{}],"hj01v":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "makeQuery", ()=>makeQuery);
var _lodash = require("lodash");
var _getCountryApi = require("./getCountryApi");
const inputEl = document.querySelector('.input');
const list = document.querySelector('.list');
const makeQuery = ()=>{
    let keyword;
    inputEl.addEventListener('input', (0, _lodash._).debounce((e)=>{
        e.preventDefault();
        list.innerHTML = "";
        keyword = e.target.value;
        (0, _getCountryApi.getCountry)(keyword);
    }, 500));
};
makeQuery();

},{"./getCountryApi":"g4RcM","lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"g4RcM":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getCountry", ()=>getCountry);
var _markup = require("./markup");
const getCountry = (keyword)=>{
    const API = `https://restcountries.com/v3.1/name/${keyword}`;
    return fetch(API).then((data)=>data.json()).then((data)=>(0, _markup.makeMarkup)(data)).catch((error)=>console.error(error));
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./markup":"3TIfq"}],"3qBDj":[function(require,module,exports,__globalThis) {
var global = arguments[3];
(function() {
